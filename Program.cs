        ...
        static void Regestretions(int? rid)
        {
            ...
            System.Console.Write("Введите свой номер телефона вместо логина:");
             int Tel=int.Parse(Console.ReadLine());
                if(Tel>0){System.Console.Write("fxgfc");}
            else
            {
            ...
            command.CommandText = $"INSERT INTO Sign_up ([Name],[Surname],[MiddleName],[Address],[sex],[phone_number],[Password],[RoleId]) VALUES ('{Name}','{Surname}','{MiddleName}','{Address}','{sex}',{Tel},'{pass}',{rid})";
